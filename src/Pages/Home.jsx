...
const Home = () => {
  ...
  const handleAddHouse = () => {
    const result = editHouseId ? editHouse(editHouseId, newHouseName) : addHouse(newHouseName);
    if (result?.error) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {houses.length === 0 ? (
          <div className="text-center p-6 bg-white rounded-xl shadow-md">
            <p className="text-lg text-gray-600">Tidak ada rumah yang terdaftar. Silakan tambahkan rumah baru.</p>
          </div>
        ) : (
